...
namespace ENGINE {
	...
	public:
		...
		static bool IsButtonDown(int scanCode);
	...
	private:
		...
		static bool keyIsDown[1024];
		static bool buttonIsDown[256];

	private:
		friend class EngineClass;
		static void SetKeyState(int scanCode, bool isDown);
		static void SetButtonState(int scanCode, bool isDown);
